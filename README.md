...
| `Package("htop", script, url)`                                  | Installs a pacman package (or AUR package, in case `PacmanPackageManager` uses one).                                                                                           |
| `PacmanKey("F3B607488DB35A47", keyserver)`                      | Installs a pacman signing key. Uses the Ubuntu keyserver by default.                                                                                                           |
