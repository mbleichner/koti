...
def base() -> Generator[ConfigGroup]:
  yield ConfigGroup("bootstrap sudo, pacman and paru").items(
  ...
  yield ConfigGroup("base packages and configs needed on every system").items(
    Package("base"),
    Package("base-devel"),
    Package("efibootmgr"),
  ...
  yield ConfigGroup("locales").items(
  ...
  yield ConfigGroup("reflector").items(
    Package("reflector"),
    *PostHookScope(
  ...
  yield ConfigGroup("arch-update").items(
    Package("arch-update"),
  ...
  yield ConfigGroup("ssh daemon + config").items(
    Package("openssh"),
...
def swapfile(size_gb: int) -> Generator[ConfigGroup]:
  yield ConfigGroup(f"swapfile ({size_gb} GByte)").items(
